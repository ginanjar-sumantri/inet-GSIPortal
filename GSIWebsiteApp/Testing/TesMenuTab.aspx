<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="TesMenuTab.aspx.cs" Inherits="GSIWebsiteApp.Testing.TesMenuTab" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <script src="../contents/jQuery/jquery-1.5.1.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div style="float: left; font-size: 8pt;">
        <div class="demo" style="width: 519px;">
            <div id="tabs">
                ...
                <asp:Literal ID="asd" runat="server"></asp:Literal>
            </div>
        </div>
        <!-- End demo -->
