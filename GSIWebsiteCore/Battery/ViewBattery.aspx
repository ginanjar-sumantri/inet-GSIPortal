<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ViewBattery.aspx.cs" Inherits="GSIWebsiteCore.Battery.ViewBattery" %>
            ...
            <table cellpadding="3" cellspacing="0" width="75%" border="0">
                ...
                <%--<tr>
                    <td style="font-family: arial; font-size: 12pt; font-weight: bold;">
                        <asp:Literal ID="BatteryCodeLiteral" runat="server"></asp:Literal>
                    </td>
                </tr>--%>
                <tr>
                    <td>
                    ...
                    <td>
                        <table cellpadding="3" cellspacing="2" width="100%" border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CodeBatteryTextBox" MaxLength="50" CssClass="TextBox"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="formTextColor">
