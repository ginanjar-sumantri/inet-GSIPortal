...
{
    public partial class ListDocumentType : DocumentTypeBase
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._documentTypeBL.GetListMsDocumentType(_maxrow, _prmCurrentPage, "DocumentTypeName", "");
        ...
        {
            MsDocumentType _temp = (MsDocumentType)e.Item.DataItem;

            Literal _documentTypeNameLiteral = (Literal)e.Item.FindControl("DocumentTypeNameLiteral");
            _documentTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.DocumentTypeName);

            Literal _documentTypeRemarkLiteral = (Literal)e.Item.FindControl("RemarkLiteral");
            _documentTypeRemarkLiteral.Text = HttpUtility.HtmlEncode(_temp.Remark);
            ...
            _viewButton.PostBackUrl = this._viewDocumentTypePage + "?" + this._documentTypeID + "=" + HttpUtility.HtmlEncode(_temp.DocumentTypeID);
        }
        ...
        {
            Response.Redirect(this._addDocumentTypePage);
        }
    }
}
