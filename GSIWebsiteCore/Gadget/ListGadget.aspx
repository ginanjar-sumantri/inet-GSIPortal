<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ListGadget.aspx.cs" Inherits="GSIWebsiteCore.Gadget.ListGadget" %>
                                                    ...
                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr runat="server" id="RepeaterItemTemplate" class="datatable_body">
                                                                ...
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="GadgetCodeLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="GadgetNameLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="BrandNameLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="NoIMEILiteral"></asp:Literal>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Literal runat="server" ID="SIMCardNumberLiteral"></asp:Literal>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
