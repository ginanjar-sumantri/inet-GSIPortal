...
{
    public partial class ListRegion : RegionBase
    {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            _viewButton.PostBackUrl = this._viewRegionPage + "?" + this._regionID + "=" + HttpUtility.HtmlEncode(_temp.RegionID);
        ...
        {
            Response.Redirect(this._addRegionPage);
        }

        protected void SyncImageButton_Click(object sender, EventArgs e)
        {
            this._wcfBL.SyncMaster("MsRegion");
            ...
            {
                this.WarningLabel.Text = "Synchronize Master Region Have Been Finished";
            }
        }
    }
}
