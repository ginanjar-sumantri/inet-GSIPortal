...
{
    public partial class ListEmployee : EmployeeBase
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._employeeBL.GetListEmployee(_maxrow, _prmCurrentPage, "EmployeeName", "");
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            Literal _employeeCodeLiteral = (Literal)e.Item.FindControl("EmployeeCodeLiteral");
            _employeeCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.EmployeeCode);

            Literal _employeeNameLiteral = (Literal)e.Item.FindControl("EmployeeNameLiteral");
            _employeeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.EmployeeName);

            Literal _genderLiteral = (Literal)e.Item.FindControl("GenderLiteral");
            _genderLiteral.Text = HttpUtility.HtmlEncode(_temp.Gender);

            Literal _handPhone1Literal = (Literal)e.Item.FindControl("HandPhone1Literal");
            _handPhone1Literal.Text = HttpUtility.HtmlEncode(_temp.HandPhone1);
            ...
            _viewButton.PostBackUrl = this._viewEmployeePage + "?" + this._employeeID + "=" + HttpUtility.HtmlEncode(_temp.EmployeeID);
        }
        ...
        {
            Response.Redirect(this._addEmployeePage);
        }
    }
}
