...
namespace GSIWebsiteCore.UserHistory
{
    public partial class ListUserHistory : UserHistoryBase
    {
        //private UserHistoryBL _userHistoryBL = new UserHistoryBL();
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
           // NameValueCollectionExtractor _nvcExtractor = new NameValueCollectionExtractor(Request.QueryString);
            ...
            //this.ListRepeater.DataSource = this._userHistoryBL.GetListUserHistoryForDDL(_maxrow, _prmCurrentPage, "Date", "Desc");

            this.ListRepeater.DataSource = this._wcfBL.GetListGenLoginHistory(_maxrow, _prmCurrentPage, "", 0, "Date", "Desc");
        ...
        {
            Gen_LoginHistory _temp = (Gen_LoginHistory)e.Item.DataItem;

            Literal _dateLiteral = (Literal)e.Item.FindControl("DateLiteral");
            _dateLiteral.Text = HttpUtility.HtmlEncode(_temp.Date);

            Literal _iPAddressLiteral = (Literal)e.Item.FindControl("IPAddressLiteral");
            _iPAddressLiteral.Text = HttpUtility.HtmlEncode(_temp.IPAddress);
        ...
        //{
        //    this._wcfBL.SyncMaster("Gen_LoginHistory");
        ...
        //    else
        //    {
        //        this.WarningLabel.Text = "Synchronize User History Have Been Finished";
        //    }
        //}
    }
}
