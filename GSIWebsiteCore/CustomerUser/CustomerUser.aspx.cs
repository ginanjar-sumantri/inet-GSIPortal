...
{
    public partial class CustomerUser : CustomerUserBase
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.AddImageButton.ImageUrl = this._imageURL + "btnAdd2.png";
            this.ListRepeater.DataSource = this._customerUserBL.GetListFromMsCustomerUser(_maxrow, _prmCurrentPage, "DisplayName", "");
        ...
        {
            double _result = RequestVariable.RowCount;
        ...
        {
            MsCustomerUser _temp = (MsCustomerUser)e.Item.DataItem;
            ...
            _viewButton.PostBackUrl = this._viewCustomerUserPage + "?" + this._customerUserID + "=" + HttpUtility.HtmlEncode(_temp.CustomerUserID);
            ...
            if (_temp.CustomerID != null)
            {
                _customerNameLiteral.Text = HttpUtility.HtmlEncode(new CustomerBL().CustomerNameByCustomerID(Convert.ToInt64(_temp.CustomerID)).CustomerName);
            }

            Literal _displayNameLiteral = (Literal)e.Item.FindControl("DisplayNameLiteral");
            _displayNameLiteral.Text = HttpUtility.HtmlEncode(_temp.DisplayName);

            Literal _userEmailAddressLiteral = (Literal)e.Item.FindControl("UserEmailAddressLiteral");
            _userEmailAddressLiteral.Text = HttpUtility.HtmlEncode(_temp.UserEmailAddress);

            Literal _mabershipUserName = (Literal)e.Item.FindControl("MembershipUserName");
            _mabershipUserName.Text = HttpUtility.HtmlEncode(_temp.MembershipUserName);
        ...
        {
            Response.Redirect(this._addCustomerUserPage);
        }

        protected void SyncImageButton_Click(object sender, EventArgs e)
        {
            this._wcfBL.SyncMaster("MsCustomerUser");
            ...
            {
                this.WarningLabel.Text = "Synchronize Master Customer User Have Been Finished";
            }
        }
    }
}
