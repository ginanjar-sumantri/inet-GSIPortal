<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ViewCustomerUser.aspx.cs" Inherits="GSIWebsiteCore.CustomerUser.ViewCustomerUser" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:CustomValidator ID="CustomerIDCustomValidator" runat="server" Text="*" ErrorMessage="Customer ID Must Be Filled"
                                                    ControlToValidate="CustomerIDDropDownList" Display="Dynamic" CssClass="warning"></asp:CustomValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="formTextColor">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="UserEmailAddressRequiredFieldValidator" runat="server"
                                                    ...
                                                    Display="Dynamic" CssClass="warning"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="UserEmailAddressTextBoxRegularExpressionValidator"
                                                    runat="server" ErrorMessage="Email Not Valid" Text="*" ControlToValidate="UserEmailAddressTextBox"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:CustomValidator ID="MembershipUserCustomValidator" runat="server" Text="*" ErrorMessage="Membership User Must Be Filled"
                                                    ControlToValidate="MembershipUserDropDownList" Display="Dynamic" CssClass="warning"></asp:CustomValidator>
                                            </td>
                                        </tr>
                                        <tr>
