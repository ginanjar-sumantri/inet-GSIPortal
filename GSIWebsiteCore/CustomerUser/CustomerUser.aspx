<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="CustomerUser.aspx.cs" Inherits="GSIWebsiteCore.CustomerUser.CustomerUser" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div style="font-size: 8pt;">
        <asp:Panel runat="server" ID="CustomerUserPanel">
                                                    ...
                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr runat="server" id="RepeaterItemTemplate" class="datatable_body">
                                                                ...
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="DisplayNameLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Literal runat="server" ID="UserEmailAddressLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="left">
