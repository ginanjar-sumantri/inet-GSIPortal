<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="AddOperator.aspx.cs" Inherits="GSIWebsiteCore.Operator.AddOperator" %>
                    ...
                    <td>
                        <table cellpadding="3" cellspacing="2" width="100%" border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="OperatorCodeTextBox" MaxLength="50" CssClass="TextBox"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="OperatorCodeRequiredFieldValidator" runat="server"
                                        ErrorMessage="Code Must Be Filled" Text="*" ControlToValidate="OperatorCodeTextBox"
