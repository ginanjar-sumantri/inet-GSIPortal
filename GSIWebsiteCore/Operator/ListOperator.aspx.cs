...
{
    public partial class ListOperator : OperatorBase
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._operatorBL.GetListMsOperator(_maxrow, _prmCurrentPage, "OperatorName", "");
        ...
        {
            MsOperator _temp = (MsOperator)e.Item.DataItem;

            Literal _operatorCodeLiteral = (Literal)e.Item.FindControl("OperatorCodeLiteral");
            _operatorCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.OperatorCode);
            ...
            _viewButton.PostBackUrl = this._viewOperatorPage + "?" + this._operatorID + "=" + HttpUtility.HtmlEncode(_temp.OperatorID);
        }
        ...
        {
            Response.Redirect(this._addOperatorPage);
        }
    }
}
