<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ViewOperator.aspx.cs" Inherits="GSIWebsiteCore.Operator.ViewOperator" %>
            ...
            <table cellpadding="3" cellspacing="0" width="75%" border="0">
                ...
                <%--<tr>
                    <td style="font-family: arial; font-size: 12pt; font-weight: bold;">
                        <asp:Literal ID="OperatorCodeLiteral" runat="server"></asp:Literal>
                    </td>
                </tr>--%>
                <tr>
                    <td>
                    ...
                    <td>
                        <table cellpadding="3" cellspacing="2" width="100%" border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CodeOperatorTextBox" MaxLength="50" CssClass="TextBox"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="CodeOperatorRequiredFieldValidator" runat="server"
                                        ErrorMessage="Code Must Be Filled" Text="*" ControlToValidate="CodeOperatorTextBox"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="OperatorNameTextBox" MaxLength="50" CssClass="TextBox"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="OperatorNameRequiredFieldValidator" runat="server"
                                        ErrorMessage="Name Must Be Filled" Text="*" ControlToValidate="OperatorNameTextBox"
                                        Display="Dynamic" CssClass="warning"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
