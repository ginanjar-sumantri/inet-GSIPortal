<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ViewSurveyPoint.aspx.cs" Inherits="GSIWebsiteCore.SurveyPoint.ViewSurveyPoint" %>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:TextBox runat="server" ID="AddressTextBox" Width="298" MaxLength="210" CssClass="TextBox"
                                                                            TextMode="MultiLine" Height="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox runat="server" ID="ClueTextBox" Width="260px" TextMode="MultiLine" MaxLength="200"
                                                                                        CssClass="TextBox" Height="150" ReadOnly="true" BackColor="#DDDDDD"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox runat="server" ID="NoteDocumentTextBox" Width="251px" TextMode="MultiLine"
                                                                                MaxLength="290" CssClass="TextBox" Height="150px" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="RemarkTextBox" Width="300" MaxLength="200" TextMode="MultiLine"
                                                    CssClass="TextBox" Height="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="formTextColor">
                                            ...
                                            <td>
                                                <asp:TextBox ID="RemarkComplaintTextBox" runat="server" TextMode="MultiLine" Width="300"
                                                    Height="150" ReadOnly="true" BackColor="#CCCCCC" CssClass="TextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="3" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="IDAddressTextBox" Width="300" MaxLength="2000" TextMode="MultiLine"
                                                    Height="150" CssClass="TextBox" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="formTextColor">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:TextBox runat="server" ID="CurrentAddressTextBox" Width="300" MaxLength="2000"
                                                                            CssClass="TextBox" TextMode="MultiLine" Height="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox runat="server" ID="ClueTextBox2" Width="260px" TextMode="MultiLine"
                                                                                        MaxLength="2000" CssClass="TextBox" Height="150" ReadOnly="true" BackColor="#DDDDDD"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="RemarkComplaintTextBox2" runat="server" TextMode="MultiLine" Width="300"
                                                    Height="150" ReadOnly="true" BackColor="#CCCCCC" CssClass="TextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
