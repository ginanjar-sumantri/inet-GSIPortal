...
{
    public partial class ViewSurveyPoint : SurveyPointBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageLiteral2.Text = this._pageTitleViewLiteral;
        ...
        private void ShowData()
        {
            if (this._nvcExtractor.GetValue(this._template) == "1")
            {
                ...
                this.RemarkComplaintTextBox.Text = _trOrderSPNotMovable.RemarkComplaint;
        ...
        {
            Response.Redirect(this._listSurveyPoint);
        }
