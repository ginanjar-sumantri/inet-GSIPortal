<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ViewWorkOrderPersonal.aspx.cs" Inherits="GSIWebsiteCore.WorkOrder.ViewWorkOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <style type="text/css">
        ...
        {
            background-image: url(/contents/images/btn_back.png);
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="RemarkResultTextBox" runat="server" Height="180px" TextMode="MultiLine"
                                            Width="250px" BackColor="#CCCCCC" CssClass="Multiline"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
