<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardMonitorBySurveyor.aspx.cs"
    Inherits="GSIWebsiteCore.Dashboard.DashboardMonitorBySurveyor" %>
...
<body>
    ...
    <div style="margin: 0px 5px 5px 5px;">
        ...
        <br />
        <br />
        <b>Survey Point Not Yet Assigned :
            <asp:Literal ID="SPNotAssignedLiteral" runat="server"></asp:Literal></b>
        <br />
        ...
        <asp:UpdatePanel runat="server" ID="UPTimeTable">
            ...
            <ContentTemplate>
                <table cellpadding="3" cellspacing="2" width="0" border="0" class="HintFont">
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr runat="server" id="RepeaterItemTemplate" class="datatable_body">
                                <td align="left">
                                    <asp:Literal ID="SurveyorLiteral" runat="server"></asp:Literal>
                                </td>
                                <td align="right">
