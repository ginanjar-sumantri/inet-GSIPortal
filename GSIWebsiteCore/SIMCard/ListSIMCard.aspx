<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ListSIMCard.aspx.cs" Inherits="GSIWebsiteCore.SIMCard.ListSIMCard" %>
    ...
    <div style="font-size: 8pt;">
        <asp:Panel runat="server" ID="SurveyPointPanel">
            <table cellpadding="3" cellspacing="0" border="0">
                                                    ...
                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr runat="server" id="RepeaterItemTemplate" class="datatable_body">
                                                                ...
                                                                <td align="left">
                                                                    <asp:Literal runat="server" ID="SIMCardCodeLiteral"></asp:Literal>
                                                                </td>
                                                                <td align="left">
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="AddImageButton" runat="server" OnClick="AddImageButton_Click" CausesValidation="true" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
