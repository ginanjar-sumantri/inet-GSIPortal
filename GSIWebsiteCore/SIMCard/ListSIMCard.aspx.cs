...
{
    public partial class ListSIMCard : SIMCardBase
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            try
            {
                ...
                this.ListRepeater.DataSource = this._sIMCardBL.GetListMsSIMCard(_maxrow, _prmCurrentPage, "", "");
            ...
            catch (Exception ex)
            {
                ...
                //string _ada = new ErrorHandler().ErrorEventLog(ex.Message);
        ...
        {
            MsSIMCard _temp = (MsSIMCard)e.Item.DataItem;

            Literal _sIMCardCodeLiteral = (Literal)e.Item.FindControl("SIMCardCodeLiteral");
            _sIMCardCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.SIMCardCode);
            ...
            _operatorNameLiteral.Text = HttpUtility.HtmlEncode(_temp.OperatorName);
            ...
            _viewButton.PostBackUrl = this._viewSIMCardPage + "?" + this._sIMCardID + "=" + HttpUtility.HtmlEncode(_temp.SIMCardID);
        }
        ...
        {
            Response.Redirect(this._addSIMCardPage);
        }
    }
}
