<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="ListUser.aspx.cs" Inherits="GSIWebsiteCore.User.ListUser" %>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="0" border="0">
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <asp:ImageButton runat="server" Text="Activate" ID="ActivateImageButton" />
                                                                                <asp:ImageButton runat="server" Text="Disable" ID="DisableImageButton" />
